  ...
  <>
    <Box direction="row" align="center" pad="medium" gap="medium">
      ...
      <Button
        ...
        hoverIndicator
      />
      <Button a11yTitle="20 Unread Emails" icon={<MailOption />} onClick={() => {}} badge hoverIndicator />
      <Button
