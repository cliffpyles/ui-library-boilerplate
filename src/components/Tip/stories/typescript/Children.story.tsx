...
import { grommet, Anchor, Box, Button, ComponentLibrary, Heading, Paragraph, Text, Tip } from "grommet";
...
export const Children = () => (
  ...
  <Box align="center" pad="large" fill>
    ...
    <Paragraph margin="none" textAlign="center">
      Tooltip is displayed once hovering on the Tip's child or when using keyboard navigation to skim through the
      webpage via tabbing.
    </Paragraph>

    <Paragraph textAlign="center">
      To ensure accessibility support for the tooltip content when using keyboard navigation, please use an{" "}
    ...
    <Box align="center" pad="large" gap="xlarge" fill>
      ...
      <Tip
        ...
        content={
          <Box align="center" background="accent-1" margin="xsmall" pad="xsmall" round="medium" flex={false}>
            <Text color="brand">Tooltip</Text>
          </Box>
        }
      >
