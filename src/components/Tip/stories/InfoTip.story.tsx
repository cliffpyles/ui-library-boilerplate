...
import { Box, Button, Text, Tip } from "../../..";
    ...
    <Tip
      content={
        <Box pad="small" gap="small" width={{ max: "small" }}>
          ...
          <>
            <Text size="small">A battle is won by him who is firmly resolved to win it.</Text>
    ...
    <Tip
      ...
      content={
        ...
        >
          ...
          <Text size="small">Help is on the way! Who are you going to call ?</Text>
        </Box>
      }
      dropProps={{ align: { left: "right" } }}
    >
