...
export const BorderBox = () => (
  <Box pad="small" gap="small" align="start">
    ...
    <Box direction="row-responsive" gap="small" align="start">
      {["solid", "dashed", "dotted", "double", "groove", "ridge", "inset", "outset"].map((type) => (
    ...
    <Box direction="row-responsive" gap="large" align="center">
      {["column", "row", "row-responsive"].map((direction) => (
        <Box key={direction} direction={direction} gap="large" border={{ side: "between", size: "large" }}>
          <Text>between </Text>
          <Text> {direction} </Text>
        </Box>
      ))}
    ...
    <Box
      direction="row"
      gap="small"
      border={[{ side: "between" }, { side: "top" }, { side: "right" }, { side: "bottom" }, { side: "left" }]}
    >
