...
export const MinMaxSizesBox = () => (
  <Box pad="small" gap="small">
    ...
    <Box pad="small" gap="small" direction="row" align="start">
      <Box width={{ max: "small" }} round="small" align="center" justify="center" background="brand" overflow="auto">
        <Text>max </Text>
      </Box>
      <Box width={{ max: "small" }} round="small" align="center" justify="center" background="brand" overflow="auto">
      ...
      <Box width={{ max: "100px" }} round="small" align="center" justify="center" background="brand" overflow="auto">
        <Text>max - width=100px, max - width=100px </Text>
      </Box>
    </Box>
    <Box pad="small" gap="small" direction="row" align="start">
      <Box width={{ min: "100px" }} round="small" align="center" justify="center" background="brand" overflow="auto">
        <Text>100px </Text>
      </Box>
      <Box width={{ min: "small" }} round="small" align="center" justify="center" background="brand" overflow="auto">
        <Text>small </Text>
      </Box>
      <Box width={{ min: "small" }} round="small" align="center" justify="center" background="brand" overflow="auto">
