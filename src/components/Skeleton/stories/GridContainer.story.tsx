...
import { Box, Button, Card, Grid, Image, Text } from "../../..";
  ...
  <Card pad="medium" gap="large" round="medium" flex="grow" {...rest}>
    <Box direction="row" gap="large" justify="between" align="center">
      <Box direction="row" gap="medium">
        <Box width="xsmall" height="xsmall" background="brand" round="small" flex={false}>
          <Image />
        </Box>
        <Box>
          <Text size="large" color="text-strong" weight="bold" skeleton={{ width: "xsmall" }}>
            {title}
          </Text>
