...
const Skeleton = forwardRef(({ as, colors: colorsProp, width: widthProp, height: heightProp, ...rest }, ref) => {
  ...
  return (
    <StyledSkeleton ref={ref} as={as} background={background} widthProp={widthProp} heightProp={heightProp} {...rest} />
  );
});
