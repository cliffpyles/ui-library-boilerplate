...
import { Box, Grid, Paragraph, ComponentLibrary, ResponsiveContext } from "../../..";
    ...
    <Box gridArea="one" background = "dark-1" />
      <Box gridArea="two" background = "dark-2" />
        <Box gridArea="three" background = "dark-3" />
          ...
          <Paragraph>
      Below a certain threshold, Columns 1 & amp; 2 switch to 50 % and Column 3 moves down to a new spot in the grid.
    < /Paragraph>
  < /ComponentLibrary>
);
