...
import { AnnounceContext, Box, ComponentLibrary, Heading, Text } from "../../..";
...
const AnnounceContextComponent = (props) => (
  <ComponentLibrary theme= { grommet } full>
    <Box justify="center" align = "center" background = "brand" fill >
      <Heading>Welcome to announcement section < /Heading>
        < AnnounceContext.Consumer > {(announce) => <Announcer announce={ announce } {...props } />}</AnnounceContext.Consumer >
          </Box>
          < /ComponentLibrary>
);
