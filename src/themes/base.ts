import { IconToolsKitchen2 as Actions } from '@tabler/icons-react';
import { IconEar as AssistListening } from '@tabler/icons-react';
import { IconInfoCircle as CircleInformation } from '@tabler/icons-react';
import { IconBadgeCc as ClosedCaption } from '@tabler/icons-react';
import { IconArrowsMaximize as Expand } from '@tabler/icons-react';
import { IconX as FormClose } from '@tabler/icons-react';
import { IconChevronDown as FormDown } from '@tabler/icons-react';
import { IconChevronRight as FormNext } from '@tabler/icons-react';
import { IconChevronLeft as FormPrevious } from '@tabler/icons-react';
import { IconChevronUp as FormUp } from '@tabler/icons-react';
import { IconArrowNarrowRight as Next } from '@tabler/icons-react';
import { IconPlayerPause as Pause } from '@tabler/icons-react';
import { IconPlayerPlay as Play } from '@tabler/icons-react';
import { IconPin as FormPin } from '@tabler/icons-react';
import { IconArrowNarrowLeft as Previous } from '@tabler/icons-react';
import { IconAlertTriangle as StatusCriticalSmall } from '@tabler/icons-react';
import { IconCheck as StatusGoodSmall } from '@tabler/icons-react';
import { IconAlertCircle as StatusWarningSmall } from '@tabler/icons-react';
import { IconQuestionMark as StatusUnknownSmall } from '@tabler/icons-react';
import { IconMinus as Subtract } from '@tabler/icons-react';
import { IconVolume as Volume } from '@tabler/icons-react';
import { IconVolume2 as VolumeLow } from '@tabler/icons-react';
